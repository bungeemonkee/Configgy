...
Configgy is the last .NET configuration library you'll ever need. It is designed to support configuration values coming from any source of any (strong) type and with any kind of validation you want.
...
Here are a bunch of things supported by Configgy out of the box:
  ...
  * Optional preemptive validation - know that a config value is bad when your app starts up (or any other time you choose) instead of hours or days later when you get some inscrutable 
